...
export const dotBackgroundColor = '#3370ff';
export const disabledButtonTextColor = '#818888';
export const dotSize = 4;
export const knobShadowColor = '#888';
export const buttonTextColor = '#2b2b2b';
export const dayNameTextColor = '#2b2b2b';
export const agendaItemBackgroundColor = '#e2eaff';
export const agendaItemTextColor = '#3370ff';