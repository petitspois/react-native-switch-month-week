...
import { InfiniteListProps } from './type';

const dataProviderMaker = (items: InfiniteListProps['data']) => new DataProvider((item1, item2) => item1 !== item2).cloneWithRows(items);

const InfiniteList = forwardRef<any, InfiniteListProps>((props, ref) => {
